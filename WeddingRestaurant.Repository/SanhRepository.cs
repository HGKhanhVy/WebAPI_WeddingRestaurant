...
{
    [ScopedDependency(ServiceType = typeof(ISanhRepository))]
    public class SanhRepository : Repository<SanhEntity>, ISanhRepository
    {
        public SanhRepository(IDbContext dbContext) : base(dbContext)
        {
