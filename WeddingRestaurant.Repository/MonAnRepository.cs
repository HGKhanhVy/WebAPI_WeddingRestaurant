...
{
    [ScopedDependency(ServiceType = typeof(IMonAnRepository))]
    public class MonAnRepository : Repository<MonAnEntity>, IMonAnRepository
    {
        public MonAnRepository(IDbContext dbContext) : base(dbContext)
        {
